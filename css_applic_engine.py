...
def login_form_post():
    ...
    <div style="margin:auto;width:50%;font-family:'Verdana';padding-top:30px">
        ...
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="4">All happiness or unhappiness solely depends upon the quality of the <div style="padding-left:20px">object to which we are attached by love.</div></div>
...
def after_sec_question():
    ...
    <div style="margin:auto;width:50%;font-family:'Verdana';padding-top:30px">
        <h1 style="text-align:left"><b>Wisdom:</h1><h3> What sentence from the sentences below describes your attitude for wisdom?.</h3>
        <form name="mypage" method="post" action="/yaaraq2/">
         ...
         <div style="padding-bottom:8px"><input type="radio" name="philosof" value="2">I am so clever that sometimes I don't understand a single word of <div style="padding-left:20px">what I am saying.</div></div>
         <div style="padding-bottom:8px"><input type="radio" name="philosof" value="3">It is better to remain silent and be thought a fool than to open one's <div style="padding-left:20px">mouth and remove all doubt. </div></div>
         ...
         <div style="padding-bottom:8px"><input name="submit" input type="submit" value="Submit">
        </form>
    </div>
    <div style="margin:auto;width:70%;text-align:right">
...
def after_third_question():
    ...
    <div style="margin:auto;width:50%;font-family:'Verdana';padding-top:30px">
    <h1 style="text-align:left">All you need is love: </h1><h3> What sentence from the sentences below describes your attitude for love?.</h3>
...
def after_fourth_question():
    ...
    <div style="margin:auto;width:50%;font-family:'Verdana';padding-top:30px">
    <h1 style="text-align:left"><b>Friendship:</h1><h3> What sentence from the sentences below describes your attitude for friendship?</h3>
        ...
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="2">True friends stab you in the front.</div>
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="3">The proper office of a friend is to side with you when you are in the <div style="padding-left:20px">wrong. Nearly anybody will side with you when you are in the right.</div></div>
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="4">Of all the things that are beyond my power, I value nothing more <div style="padding-left:20px">highly than to be allowed the honor of entering into bonds of friendship with people who sincerely love truth.</div></div>
        <input name="submit" input type="submit" value="Submit">
        </form>
    </div>
    <div style="margin:auto;width:70%;text-align:right">
...
def after_fourth_question():
    ...
    <div style="margin:auto;width:50%;font-family:'Verdana';padding-top:30px">
    <h1 style="text-align:left">And a last sentence to make this world a better place:</h1><h3> What sentence from the sentences below describes your attitude?</h3>
        <form name="mypage" method="post" action="/yaarasol/">
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="1">Don't underestimate the value of doing nothing, of just going along,<div style="padding-left:20px"> listening to all the things you cant hear,and not bothering.</div></div>
        ...
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="3">Good friends, good books and a sleepy consciencethis is the ideal life. <div style="padding-left:20px">The conviction of the rich that the poor are happier is no more foolish than the conviction of the poor that the rich are.</div></div>
        <div style="padding-bottom:8px"><input type="radio" name="philosof" value="4">The world would be happier if men had the same capacity to be silent <div style="padding-left:20px">that they have to speak.</div></div>
        <input name="submit" input type="submit" value="Submit">
        </form>
    </div>
    <div style="margin:auto;width:70%;text-align:right">
